'''
Script to generate quiver mutation classes for use in ML classification. 
'''
# Import libraries 
import numpy as np
...
# Define the max depth to generate the mutation classes to
depth_NMA = 5
depth_MA = 7
